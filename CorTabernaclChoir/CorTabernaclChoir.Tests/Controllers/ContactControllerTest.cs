...
namespace CorTabernaclChoir.Tests.Controllers
{
    ...
    public class ContactControllerTest
    {
        ...
        {
            // Arrange
            var mockViewModel = new ContactViewModel { MainText = "ABC" };

            var mockHandler = new Mock<IContactService>();
            var mockCultureService = new Mock<ICultureService>();
            var controller = new ContactController(mockHandler.Object, mockCultureService.Object);
